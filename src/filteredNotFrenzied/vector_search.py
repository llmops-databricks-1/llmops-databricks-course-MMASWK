...
class VectorSearchManager:
    """Manages vector search endpoints and indexes for mdpi paper chunks."""
    ...
    def __init__(
        ...
        self.index_name = f"{self.catalog}.{self.schema}.mdpi_index"
    ...
    def create_or_get_index(self) -> Any:
        ...
        source_table = f"{self.catalog}.{self.schema}.mdpi_chunks_table"
