"""Configuration management for MDPI Scraper."""
...
class ScraperConfig(BaseModel):
    """MDPI web scraper configuration."""

    base_url: str = Field("https://www.mdpi.com", description="MDPI base URL")
    search_query: str = Field(..., description="Search query for MDPI papers")
    max_results: int = Field(100, description="Maximum number of papers to scrape")
